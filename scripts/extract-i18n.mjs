...
/* i18n 数据 —— 由 scripts/extract-i18n.mjs 从 gui/app.js 提取生成。
   ...
   de/fr 为 Rust 线扩展语言(_I18N.de/_I18N.fr 由本移植新增, 非 C#
   谱系逐字资产);二者的服务器消息走透传(与 zh/en 同策略,
   _srv 仅 ja 生效)。 */
...
export const LANGS = ["zh", "en", "ja", "de", "fr"];
export const LANG_CODES = { zh: "中", en: "EN", ja: "あ", de: "DE", fr: "FR" };          // 按钮代码(各语言自称)
export const LANG_MENU = { zh: "中文(简体)", en: "English", ja: "日本語", de: "Deutsch", fr: "Français" }; // 菜单项(各自语言, 不走翻译)
`;
